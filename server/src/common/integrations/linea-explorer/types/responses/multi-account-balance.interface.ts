...
export interface ILineaExplorerMultiAccountBalanceData {
...
export type TLineaExplorerMultiAccountBalanceResponse = ILineaExplorerGenericResponse<
  ILineaExplorerMultiAccountBalanceData[]
>;
